        ...
        <div class="detail">
          <div class="detail__header">
            <div :class="[isWhite ? 'day' : 'night', 'detail__userInfo']">
              <nuxt-link :to="'/user/' + articDetail.attributes.author.data.id" class="detail__user__avatar"
                target="_blank">
                <user-avatar :url="
              ...
              <nuxt-link :to="'/user/' + articDetail.attributes.author.data.id"
                :class="[isWhite ? 'day' : 'night', 'detail__user__name']" target="_blank">
          ...
          <div v-if="articDetail.attributes.cover_image.data" class="detail__cover"
            :style="`background-image: url(${articDetail.attributes.cover_image.data.attributes.url})`"></div>
...
import aboutAuthor from "~/components/layout/detail/aboutAuthor.vue";
import aboutArticle from "~/components/layout/detail/aboutArticle.vue";
import catalog from "~/components/layout/detail/catalog.vue";
export default {
  async asyncData({ app, params }) {
    console.log("opreating");
    // 检查是否有响应
