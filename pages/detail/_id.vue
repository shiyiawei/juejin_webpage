<template>
  <div class="detail-container">
    <div class="detail-main">
      <div class="detail-block shadow" :class="[isWhite? 'topBarDay':'topBarNight', 'detail-block','shadow']">
        <div class="detail">
          <h1 :class="[isWhite? 'topBarDay':'topBarNight', 'detail__title']">{{ articDetail.attributes.title }}</h1>
          <div class="detail__header">
            <div :class="[isWhite? 'topBarDay':'topBarNight', 'detail__userInfo']">
              <nuxt-link
              ...
              >
                <user-avatar
                  :to="'/user/'+ articDetail.attributes.author.data.avater"
                  :round="true"
                ></user-avatar>
              </nuxt-link>
              ...
              <nuxt-link
                :to="'/user/' + articDetail.attributes.author.data.id"
                :class="[isWhite? 'topBarDay':'topBarNight', 'detail__user__name']"
                target="_blank"
              >
