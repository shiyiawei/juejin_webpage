<template>
  <div class="r-bottom">
    ...
    <div></div>
    <el-link type="info"><img style="width: 15px; height: 15px;" src="~/assets/images/png/police.png">京公网安备11010802026719号</el-link>
    <div></div>
    ...
    <div></div>
    <el-button type="text">
      <img src="~/assets/images/png/weibo.png">
    </el-button>
    <el-button type="text">
      <img src="~/assets/images/png/wechat.png">
    </el-button>
  </div>
</template>
