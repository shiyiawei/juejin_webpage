<template>
  <div class="author-block shadow">
    <div :class="[isWhite? 'topBarDay':'topBarNight', 'author-block__title']">🎖️ 作者榜</div>
    <div v-for="item in list" :key="item.id">
      <div :class="[isWhite? 'topBarDay':'topBarNight', 'author-item']">
        <div class="author__avatar">
          <user-avatar :url="getUrl(item.attributes.avatar_large.data.attributes.url)" :round="true"></user-avatar>
        </div>
        <div class="author__info">
          <div :class="[isWhite? 'topBarDay':'topBarNight', 'author__name']">
