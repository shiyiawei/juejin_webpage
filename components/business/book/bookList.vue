<template>
  <div :class="[isWhite? 'topBarDay':'topBarNight', 'books']">
    <div :class="[isWhite? 'topBarDay':'topBarNight', 'book-item']" v-for="item in list" :key="item.booklet_id">
      <div class="book__cover" :style="`background-image: url(${item.base_info.cover_img})`"></div>
      <div :class="[isWhite? 'topBarDay':'topBarNight', 'book__info']">
        <div class="book__title">{{ item.base_info.title }}</div>
        <div :class="[isWhite? 'topBarDay':'topBarNight', 'book__desc', 'ellipsis']">{{ item.base_info.summary }}</div>
        <div :class="[isWhite? 'topBarDay':'topBarNight', 'book__author']">
